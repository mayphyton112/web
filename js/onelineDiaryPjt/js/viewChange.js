...
function initviews(){
    ...
    signinWrap = document.querySelector('div.sign_up_wrap'); /*쿼리 선택자*/
    writeWrap = document.querySelector('div.sign_up_wrap'); /*쿼리 선택자*/ //화면에 대한 것을 다 선택해서 위의 변수로 할당한다.
    listWrap = document.querySelector('div.sign_up_wrap'); /*쿼리 선택자*/
    // console.log('signUpWrap: ', signUpWrap);

}

// 사용자가 원하는 뷰를 보이게 한다.
function showSelctionedView() {
